...
namespace VigProject_Api.Controllers
{
    [Route("api/videojwt")]
    [ApiController]
    public class VideoPortalController_JWT : Controller
    {
        ...
        public async Task<IActionResult> getVideoCategory(student_input deserializedProduct)
        {
            try
            {
                ...
                objRetModel.Student_category_model_list = await objCitiRepo.repo_Student_category(User.GetMsrno(), "video");
        ...
        public async Task<IActionResult> getVideoList(student_input deserializedProduct)
        {
            try
            {
                ...
                objRetModel.Student_video_model_list = await objCitiRepo.repo_Student_videolist(User.GetMsrno(), deserializedProduct.categoryid, "video");
        ...
        public async Task<IActionResult> getVideoStart(student_input deserializedProduct)
        {
            try
            {
                ...
                objRetModel.Student_video_model_playlist = await objCitiRepo.repo_Student_videoStart(User.GetMsrno(), deserializedProduct.videoid, "video");
